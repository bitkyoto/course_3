...
void SceneInterface::paintStacks(QPainter *painter)
{
    ...
    painter->drawRect(QRect(QPoint(50,20),QPoint(700,650)));
    ...
    QPoint stack1_x2y2 = QPoint(150,580);
    QPoint stack2_x2y2 = QPoint(250,580);
    QPoint stack3_x2y2 = QPoint(350,580);
    QPoint stack4_x2y2 = QPoint(450,580);
